...
# Update environment variables for cindymyrex app
APP_ID="5103bfe7-8bef-43d9-b9c5-dd29e5c41808"

echo "Updating environment variables for canvassing-cindymyrex..."
...
- name: frontend
  ...
  - key: REACT_APP_API_URL
    value: "https://canvassing-cindymyrex.ondigitalocean.app/api"
  - key: NODE_ENV
    value: "production"
...
echo "Environment variables updated! The app will redeploy automatically."
echo ""
