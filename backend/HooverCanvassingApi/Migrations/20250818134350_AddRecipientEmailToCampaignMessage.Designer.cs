...
namespace HooverCanvassingApi.Migrations
{
    ...
    [Migration("20250818134350_AddRecipientEmailToCampaignMessage")]
    partial class AddRecipientEmailToCampaignMessage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.Campaign", b =>
                {
                    ...
                    b.Property<string>("EmailPlainTextContent")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.EmailUnsubscribe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.OptOutRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.PhoneBankingCall", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("TwimlContent")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.ToTable("PhoneBankingCalls");
                });

            modelBuilder.Entity("HooverCanvassingApi.Models.PhoneContact", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.VoterLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.PhoneBankingCall", b =>
                {
                    b.HasOne("HooverCanvassingApi.Models.Volunteer", "User")
                        .WithMany()
