...
namespace HooverCanvassingApi.Migrations
{
    ...
    [Migration("20250706052659_AddWalkFeature")]
    partial class AddWalkFeature
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.AdditionalResource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.AppSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.HouseClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("VotersHome")
                        .HasColumnType("integer");

                    b.Property<int>("WalkSessionId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("WalkSessionId");

                    b.HasIndex("Latitude", "Longitude");

                    b.ToTable("HouseClaims");
                });
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.WalkActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.WalkSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.HouseClaim", b =>
                {
                    b.HasOne("HooverCanvassingApi.Models.WalkSession", "WalkSession")
                        .WithMany("HouseClaims")
                        .HasForeignKey("WalkSessionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("WalkSession");
                });
            ...
            modelBuilder.Entity("HooverCanvassingApi.Models.WalkActivity", b =>
                {
                    b.HasOne("HooverCanvassingApi.Models.HouseClaim", "HouseClaim")
                        .WithMany()
                        .HasForeignKey("HouseClaimId")
                        .OnDelete(DeleteBehavior.SetNull);
