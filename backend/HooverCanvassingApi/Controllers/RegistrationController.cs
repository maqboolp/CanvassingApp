    ...
    public class RegistrationController : ControllerBase
    {
        ...
        public async Task<ActionResult> SendInvitation([FromBody] SendInvitationRequest request)
        {
            try
            {
                ...
                var registrationUrl = $"https://robin-litaker-png8l.ondigitalocean.app/complete-registration?token={token}";
        ...
        public async Task<ActionResult> ResendInvitation(string invitationId)
        {
            try
            {
                ...
                // Generate registration URL
                var registrationUrl = $"https://robin-litaker-png8l.ondigitalocean.app/complete-registration?token={invitation.Token}";
